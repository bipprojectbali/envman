        ...
        <Group gap="sm" wrap="wrap">
          ...
          {config.connectionId && (
            <Anchor
              ...
              params={{ id: config.connectionId } as never}
            >
              <Group gap={4} wrap="nowrap">
                <TbServer size={12} />
      ...
      {activeOp && (
        ...
        >
          <Group justify="space-between" wrap="nowrap" gap="xs">
            ...
            {activeOp.done && (
              <ActionIcon size="xs" variant="subtle" color="gray" onClick={onDismissOp}>
                <TbX size={12} />
              </ActionIcon>
            )}
          </Group>
        ...
        >
          <Group justify="space-between" gap="xs" wrap="nowrap">
            ...
            <Switch
              ...
              onChange={(e) => onToggleAutoSync(e.currentTarget.checked)}
              size="sm"
              style={{ flexShrink: 0 }}
            />
          </Group>
