...
import { openInEditor, storageKey } from './shared-node-types'
    ...
    <>
      <Group px="md" pb="xs" gap="sm">
        ...
        <Tooltip label="Reload">
          <ActionIcon variant="subtle" size="sm" loading={isFetching} onClick={() => qc.invalidateQueries({ queryKey: ['admin', 'test-coverage'] })}>
            <TbRefresh size={16} />
          </ActionIcon>
        </Tooltip>
      </Group>
