    ...
    <Box>
      ...
      {!encryptionEnabled && (
        <Alert icon={<TbAlertTriangle size={14} />} color="orange" mb="sm" py="xs">
          <Text size="xs">
            <strong>MASTER_KEY</strong> belum di-set — secret vars disimpan plaintext.
          </Text>
        </Alert>
      )}
      ...
      <VarsToolbar
        ...
        setCopiedSelected={setCopiedSelected}
        copiedKeys={copiedKeys}
        setCopiedKeys={setCopiedKeys}
        copyToClipboard={copyToClipboard}
        canEdit={canEdit}
        isOwner={isOwner}
        plainCount={plainCount}
        secretCount={secretCount}
        revealAllPlain={revealAllPlain}
        toggleRevealAllPlain={toggleRevealAllPlain}
      ...
      <VarsEmptyState
        ...
        filteredVars={filteredVars}
        importedDisplay={importedDisplay}
        canEdit={canEdit}
        setSearch={setSearch}
        setFilterType={setFilterType}
        setFilterDisabled={setFilterDisabled}
      ...
      {isMobile ? (
        ...
        <VarsTableDesktop
          ...
          disabledCount={disabledCount}
          varsPage={varsPage}
          setVarsPage={setVarsPage}
          varsTotalPages={varsTotalPages}
          editingId={editingId}
          editForm={editForm}
          setEditForm={setEditForm}
          updateVar={updateVar}
