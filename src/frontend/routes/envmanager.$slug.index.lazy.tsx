        ...
        <Tabs value={tab} onChange={(v) => setTab(v ?? 'environments')} variant="pills" color="gray">
          ...
          <Tabs.Panel value="environments">
            <Paper withBorder p="md" radius="md">
              ...
              >
                Environment menyimpan variabel konfigurasi per tahap deployment. Klik environment untuk mengelola vars,
                atau akses dari CLI: <Code fz="xs">envman -e {slug}:production -- bun start</Code>
              </Alert>
