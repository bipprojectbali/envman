...
import { useTokensPage, emptyForm } from '@/frontend/hooks/useTokensPage'
        ...
        <Stack gap="md">
          ...
          <Box p="md" style={{ borderRadius: 'var(--mantine-radius-md)', border: '1px solid var(--mantine-color-default-border)' }}>
            ...
            <Group gap="xs" mb="md" wrap="wrap">
              <Badge size="xs" color={p.form.canWrite ? 'orange' : 'blue'} variant="light">
                {p.form.canWrite ? 'read-write' : 'read-only'}
              </Badge>
              <Badge size="xs" color="primary" variant="light">
                {p.form.scopes.length === 0 ? 'semua project' : `${p.form.scopes.length} scope`}
              </Badge>
      ...
      <Paper withBorder p="md" radius="md">
        <Stack gap="md">
          ...
          <Box p="md" style={{ borderRadius: 'var(--mantine-radius-md)', border: '1px solid var(--mantine-color-default-border)' }}>
            ...
            <Divider my="md" />
            <Group gap="xs" mb="md" wrap="wrap">
              <Badge size="xs" color={p.editForm.canWrite ? 'orange' : 'blue'} variant="light">
                {p.editForm.canWrite ? 'read-write' : 'read-only'}
              </Badge>
              <Badge size="xs" color="primary" variant="light">
                {p.editForm.scopes.length === 0 ? 'semua project' : `${p.editForm.scopes.length} scope`}
              </Badge>
