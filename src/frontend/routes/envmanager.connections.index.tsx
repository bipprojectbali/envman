      ...
      {!isLoading && connections.length === 0 ? (
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, lg: 3 }} spacing="sm">
          {filteredConnections.map(c => (
            <Card
              key={c.id} withBorder p="md"
              style={{ cursor: 'pointer' }}
              onClick={() => navigate({ to: '/envmanager/connections/$id', params: { id: c.id } })}
            >
              ...
              <Group gap="xs">
                ...
                <ActionIcon size="xs" variant="subtle" color="gray" component="a" href={c.portainerUrl} target="_blank" rel="noreferrer" onClick={e => e.stopPropagation()}>
